...
const config = {
    ...
    //Added babel polyfill to support async tasks
    entry: [
        'babel-polyfill',
        './main.js',
    ...
    output: {
        filename: 'bundle.js',
        path: resolve(__dirname, 'backend/public'), //Changed this!
        publicPath: '',
    },
    ...
    plugins: [
        ...
        //Removed this because it's express the one rendering files

        /*new HtmlWebpackPlugin({
            template: `${__dirname}/backend/views/index.ejs`,
            filename: 'index.ejs',
            inject: false,
        }),*/
